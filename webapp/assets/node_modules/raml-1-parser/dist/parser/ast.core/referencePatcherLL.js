                ...
                if (!excessive) {
                    ...
                    if (collectionName == def.universesInfo.Universe10.LibraryBase.properties.types.name) {
                        ...
                        if (discriminator.length > 0) {
                            ...
                            if (localType) {
                                var resolver = rootUnit.project().namespaceResolver();
                                for (var _d = 0, _e = localType.allSubTypes(); _d < _e.length; _d++) {
                                    var st = _e[_d];
                                    ...
                                    var ref_1 = new referencePatcherHL.PatchedReference(ns, typeName_1, def.universesInfo.Universe10.LibraryBase.properties.types.name, unit, false, this.mode);
                                    this.registerPatchedReference(ref_1);
                                }
                            }
                        }
                    }
