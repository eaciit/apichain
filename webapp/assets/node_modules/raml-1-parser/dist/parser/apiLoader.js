...
function load(ramlPath, options) {
    options = options || {};
    return parse(ramlPath, options).then(function (expanded) {
...
function loadSync(ramlPath, options) {
    options = options || {};
    var expanded = parseSync(ramlPath, options);
    return jsonSerializerHL.dump(expanded, {
        rootNodeDetails: true,
        attributeDefaults: true,
        serializeMetadata: true,
...
function parse(ramlPath, options) {
    options = options || {};
...
exports.parse = parse;
function parseSync(ramlPath, options) {
    options = options || {};
