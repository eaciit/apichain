...
export declare function parse(ramlPath: string, options?: parserCoreApi.Options2): Promise<hl.IHighLevelNode>;
export declare function parseSync(ramlPath: string, options?: parserCoreApi.Options2): hl.IHighLevelNode;
/***
