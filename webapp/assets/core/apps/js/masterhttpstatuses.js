  ...
  $("#grid-main").kendoGrid({
    dataSource: {
      transport: {
        ...
        update: function(o){
          ajaxPost("/masterhttpstatuses/save", { id: o.data._id, name: o.data.name }, function(res){
            o.success(res.Data);
            refreshGrid();
          });
        },
        ...
        destroy: function(o){
          ajaxPost("/masterhttpstatuses/delete", { id: o.data._id, name: o.data.name }, function(res){
            o.success(res.Data);
            refreshGrid();
          });
        },
